      ...
      <div v-if="isOpen" class="modal-wrapper">
        <div class="modal-backdrop" @click.self="!loading && emit('close')">
          <div ref="modalRef" class="modal">
            ...
            <input type="date" class="date" v-model="deadline" @blur="dateTouched = true"/>
            ...
            <div class="file-upload">
              ...
              <label class="file-btn">
                <input
                  ...
                  class="hidden-input"
                  @change="onFileChange" />
                <svg class="file-icon" width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
